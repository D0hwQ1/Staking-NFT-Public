 ...
 */
abstract contract IKIP17 is IKIP13 {
 ...
 */
abstract contract IKIP17Enumerable is IKIP17 {
 ...
 * @dev See http://kips.klaytn.com/KIPs/kip-17-non_fungible_token
 */
abstract contract IKIP17Metadata is IKIP17 {
...
contract KIP17 is KIP13, IKIP17, IKIP17Enumerable, IKIP17Metadata, MinterRole {
    using SafeMath for uint256;
 ...
 * @dev see http://kips.klaytn.com/KIPs/kip-17-non_fungible_token
 */
contract KIP17Full is KIP13, KIP17, Pausable {
    /*
    ...
    function mintWithTokenURIForSell(address to, uint256 tokenId, string memory tokenURI) internal returns (bool) {
        _mint(to, tokenId);
        _setTokenURI(tokenId, tokenURI);
        return true;
    }
...
contract KIP17Token is KIP17Full, Ownable {
    constructor (string memory name, string memory symbol) KIP17Full(name, symbol) {
    }
}